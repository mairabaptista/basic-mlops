...
texinfo_documents = [
    ('index', 'mlops-deploy', u'mlops-deploy Documentation',
     u"mairabaptista", 'mlops-deploy',
     'A simple FastAPI app serving a ML model. This repository is a playground to test features such as cookiecutter.', 'Miscellaneous'),
]
